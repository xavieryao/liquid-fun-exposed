...
public class liquidfunJNI {
  ...
  public final static native long World_getBodyList(long jarg1, World jarg1_);
  ...
  public static void SwigDirector_Draw_drawPolygon(Draw self, byte[] vertices, int vertexCount, long color) {
    self.drawPolygon(vertices, vertexCount, new Color(color, false));
  }
  public static void SwigDirector_Draw_drawSolidPolygon(Draw self, byte[] vertices, int vertexCount, long color) {
    self.drawSolidPolygon(vertices, vertexCount, new Color(color, false));
  }
  public static void SwigDirector_Draw_drawCircle(Draw self, long center, float radius, long color) {
    self.drawCircle(new Vec2(center, false), radius, new Color(color, false));
  }
  public static void SwigDirector_Draw_drawSolidCircle(Draw self, long center, float radius, long axis, long color) {
    self.drawSolidCircle(new Vec2(center, false), radius, new Vec2(axis, false), new Color(color, false));
  }
  public static void SwigDirector_Draw_drawParticles(Draw self, byte[] centers, float radius, byte[] colors, int count) {
    self.drawParticles(centers, radius, colors, count);
  }
  public static void SwigDirector_Draw_drawSegment(Draw self, long p1, long p2, long color) {
    self.drawSegment(new Vec2(p1, false), new Vec2(p2, false), new Color(color, false));
  }
  public static void SwigDirector_Draw_drawTransform(Draw self, long xf) {
    self.drawTransform(new Transform(xf, false));
  }
  public static boolean SwigDirector_QueryCallback_reportFixture(QueryCallback self, long fixture) {
    return self.reportFixture((fixture == 0) ? null : new Fixture(fixture, false));
  }
  public static boolean SwigDirector_QueryCallback_reportParticle(QueryCallback self, long particleSystem, int index) {
    return self.reportParticle((particleSystem == 0) ? null : new ParticleSystem(particleSystem, false), index);
  }
